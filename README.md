...
# Análisis:
En rasgos generales las ventan aparentan buenos números con un margen de beneficio del 11%. El mayor problema es que hay casi un 25% de los pedidos que no dejan beneficios y generan pérdidas. Turquia con unas pérdidas de 93.000$ y un 100% de pedidos sin beneficio en 649 pedidos esta a la cabeza de estos malos datos. Nigeria 78.000$ y Paises Bajos 40.000$ de pérdias le siguen. En Argentina un 90% de los 183 pedidos y en Honduras un 88% de 327 dan pérdidas. Hay una lista de más de 20 paises con una cantidad de pedidos reseñable con más de la mitad de los pedidos con pérdidas. Algo que se puede comprobar en el mapa del dashboard.  
...
El mayor problema para estos pedidos son los descuentos, a partir del 20% de descuento los beneficios caen dando lugar en algunos casos a estas perdidas.
